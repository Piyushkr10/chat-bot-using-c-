...
int main(){
    ...
    while (true)
    {
        ...
        if (user_input=="hi"|| user_input == "hello"|| user_input=="hye")
        {
            cout<<"Hello User, how can i help you?"<<endl;
        }
        else if (user_input== "how are you" || user_input=="are you ok")
        {
            cout<<"As a chatbot i have no emotion states"<<endl;
        }
        else if (user_input=="what's my name")
        {
            ...
            {
                cout<<"Sorry you didn't tell your name yet, Tell me your name"<<endl;
            }
        ...
        else if (user_input=="byee" || user_input=="see you later"|| user_input=="later")
        {
            cout<<"Bye";
            break;
        }
